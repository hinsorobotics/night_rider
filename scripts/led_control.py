...
#-------------- function deleceration -----------------------------------------
        ...
        rospy.Subscriber("/led_light_control", ByteMultiArray, self.callbackSetLEDs)
...
#-------------- function deleceration -----------------------------------------
    ...
    def control_relay_write_array(self, dataArray):
        print(len(dataArray.data))
        led = 0
    ...
    def callbackSetLEDs(self, dataArray): 
		self.control_relay_write_array(dataArray)
		return	
